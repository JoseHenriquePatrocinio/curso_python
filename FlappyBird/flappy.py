...
# Classe que define o sprite do pássaro controlado pelo jogador
...
# Configurar a posição do ground no eixo x e y da tela.
...
BACKGROUND = pygame.image.load('imagens/background-day.png')
...
# Loop principal do jogo e é executado continuamente até que o jogador feche a janela.
while True:
    clock.tick(30)
    ...
    screen.blit(score_surface, ((SCREEN_WIDTH - score_surface.get_width()) / 2, 10))
    ...
    if (pygame.sprite.groupcollide(bird_group, ground_group, False, False, pygame.sprite.collide_mask) or
        ...
        screen.blit(game_over_surface, ((SCREEN_WIDTH - game_over_surface.get_width()) / 2, SCREEN_HEIGHT / 2))
        pygame.display.update()
